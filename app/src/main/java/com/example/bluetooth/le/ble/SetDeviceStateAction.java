...
public class SetDeviceStateAction extends PlainAction {
    private final HADevice device;
    private final HADevice.State deviceState;
    private final Context context;

    public SetDeviceStateAction(HADevice device, HADevice.State deviceState, Context context) {
        this.device = device;
